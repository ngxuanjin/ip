...
public class Kiaw {
    ...
    /**
     * Executes a parsed command and returns the resulting response.
     *
     * @param command parsed user command
     * @return response generated by the command
     * @throws KiawException if the command type is not recognised
     * @throws IOException if task data cannot be saved
     */
    private String executeCommand(ParsedCommand command)
